...
\set skill_quantity :mid_value
\set job_location_quantity :mid_value
\set account_quantity :mid_value
\set company_quantity :mid_value
\set education_quantity :mid_value
\set experience_detail_quantity :mid_value
\set limit_num 0;
